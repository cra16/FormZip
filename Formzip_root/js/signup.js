...
function FindCheck(){
	...
	if(find.value == "")
	{
		document.getElementById("findMsg").style.display="block";
		document.getElementById("findMsg").innerHTML="필수정보입니다";
		check_arr[4]=0;
	}
		
	else{
		document.getElementById("findMsg").style.display="none";		
		check_arr[4]=1;
	}
}
